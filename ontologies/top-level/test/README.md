...
cd knowledge-graph/ontologies/top-level
```
...
```
INFO 2025-03-24 14:53:18,438 [main] (OWLUnit.java:89) - Test case URI https://w3id.org/hacid/data/testcase/top1.ttl
